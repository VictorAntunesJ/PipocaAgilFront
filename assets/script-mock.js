...
const modalEventVideoContainer = document.getElementById('modalEventVideoContainer');
...
const initialFakeEvents = [
  {
    ...
    imageUrl: "/assets/img/Gemini_Generated_Image_eccj9ieccj9ieccj.png",
  },
  {
    id: "fake-event-2",
    ...
    imageUrl: "/assets/img/Gemini_Generated_Image_fvnql2fvnql2fvnq.png",
  },
  {
    id: "fake-event-3",
    ...
    imageUrl: "/assets/img/Gemini_Generated_Image_klfmklklfmklklfm.png", // Exemplo: Rick Astley - Never Gonna Give You Up
  },
  {
    id: "fake-event-4",
    ...
    imageUrl:
      "/assets/img/Gemini_Generated_Image_jodeixjodeixjode.png",
  },
];
...
window.registerForEvent = function () {
    showAlert("Inscrição simulada com sucesso! (Funcionalidade não completa)", "info");
};
